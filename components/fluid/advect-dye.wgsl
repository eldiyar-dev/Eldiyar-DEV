...
fn main(@builtin(global_invocation_id) id: vec3u) {
  ...
  // --signal: #00C48C
  color += vec4f(0.0, 0.7686, 0.5490, 1.0) * emitter_weight(p, input.idle_a, aspect) * 0.12;
  // Complementary accent to --signal: #C40038
  color += vec4f(0.7686, 0.0, 0.2196, 1.0) * emitter_weight(p, input.idle_b, aspect) * 0.115;
